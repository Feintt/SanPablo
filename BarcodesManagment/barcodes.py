...
class BarcodeManager:
    ...
    DataBase.create_table_if_not_exists('barcodes', 'barcode TEXT NULL, product_id INT NULL, barcode_path TEXT NULL')
    ...
    def return_barcode_path_from_barcode(self, barcode: str):
        return self.DataBase.cursor.execute(f'SELECT barcode_path FROM barcodes WHERE barcode = "{barcode}"').fetchone()[0]
